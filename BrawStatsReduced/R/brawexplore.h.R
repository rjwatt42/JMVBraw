...
BrawExploreOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "BrawExploreOptions",
...
BrawExploreResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "BrawExploreResults",
...
BrawExploreBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "BrawExploreBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = BrawExploreResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
BrawExplore <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("BrawExplore requires jmvcore to be installed (restart may be required)")


    options <- BrawExploreOptions$new(
        DVname = DVname,
        DVtype = DVtype,
        DVmu = DVmu,
        DVsd = DVsd,
